...
const ExploreSlide = ({data, newClasses, urlImg}) => {
    ...
    return (
                        ...
                        <a href="#" className="card" style={{"backgroundImage" : `url(${urlImg})`}}>
                            <div className={`card__controls ${newClasses}`}>
                                <div className={`card__controls-count ${newClasses}`}>{`Module #${slideNumer}`}</div>
                            ...
                            <div className={`card__title ${newClasses}`}>{title}</div>
                            <div className={`card__description ${newClasses}`}>
